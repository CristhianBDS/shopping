...
<form class="row gy-2 gx-2 mb-3" method="get">
  <div class="col-md-4">
    <input class="form-control" type="text" name="q" value="<?= htmlspecialchars($q) ?>" placeholder="Buscar por nombre o email">
  </div>
  <div class="col-md-3">
      ...
      <tr>
        ...
        <td class="text-end">
          <div class="btn-group btn-group-sm">
            <a class="btn btn-outline-secondary" href="<?= $BASE ?>/admin/usuario_form.php?id=<?= (int)$u['id'] ?>">Editar</a>
            <?php if (can('usuarios:state')): ?>
              <form method="post" class="d-inline">
                ...
                <?php if ((int)$u['is_active'] === 1): ?>
                  ...
                  <button class="btn btn-outline-danger" onclick="return confirm('¿Desactivar este usuario?')">Desactivar</button>
                <?php else: ?>
